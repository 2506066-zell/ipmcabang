        ...
        list.innerHTML = articles.map(art => `
            <div class="list-item">
                ...
                <div style="display:flex; gap:8px;">
                     ...
                     <a href="${art.slug ? `/articles/${encodeURIComponent(art.slug)}` : `/articles?id=${encodeURIComponent(art.id)}`}" target="_blank" class="btn btn-secondary btn-sm"><i class="fas fa-external-link-alt"></i> Lihat</a>
                </div>
            </div>
        `).join('');
