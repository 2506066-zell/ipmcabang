module.exports=[72071,E=>{"use strict";var T=E.i(43793);async function A(){try{await T.query`
    ...
    `}catch(E){console.error("Schema bootstrap error:",E)}}E.s(["ensureSchema",0,A])}];

//# sourceMappingURL=src_lib_bootstrap_ts_0sq9edh._.js.map