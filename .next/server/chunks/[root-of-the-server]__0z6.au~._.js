...
</html>`)}}},91784,e=>{"use strict";var a=e.i(26747),t=e.i(90406),i=e.i(44898),n=e.i(62950);let r=e.r(34777);async function o(e,a){return r(e,a)}e.s(["default",0,o],33022);var s=e.i(33022),d=e.i(7031),l=e.i(81927),m=e.i(46432);let g=(0,n.hoist)(s,"default"),p=(0,n.hoist)(s,"config"),u=new i.PagesAPIRouteModule({definition:{kind:t.RouteKind.PAGES_API,page:"/api/article-share",pathname:"/api/article-share",bundlePath:"",filename:""},userland:s,distDir:".next",relativeProjectDir:""});async function c(e,t,i){i.requestMeta&&(0,m.setRequestMeta)(e,i.requestMeta),u.isDev&&(0,m.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let n="/api/article-share";n=n.replace(/\/index$/,"")||"/";let r=await u.prepare(e,t,{srcPage:n});if(!r){t.statusCode=400,t.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve());return}let{query:o,params:s,prerenderManifest:g,routerServerContext:p}=r;try{let a,i=e.method||"GET",r=(0,d.getTracer)(),m=r.getActiveScopeSpan(),c=!!(null==p?void 0:p.isWrappedByNextServer),h=u.instrumentationOnRequestError.bind(u),w=async d=>u.render(e,t,{query:{...o,...s},params:s,allowedRevalidateHeaderKeys:[],multiZoneDraftMode:!1,trustHostHeader:!1,previewProps:g.preview,propagateError:!1,dev:u.isDev,page:"/api/article-share",internalRevalidate:null==p?void 0:p.revalidate,onError:(...a)=>h(e,...a)}).finally(()=>{if(!d)return;d.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let e=r.getRootSpanAttributes();if(!e)return;if(e.get("next.span_type")!==l.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${e.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let o=e.get("next.route");if(o){let e=`${i} ${o}`;d.setAttributes({"next.route":o,"http.route":o,"next.span_name":e}),d.updateName(e),a&&a!==d&&(a.setAttribute("http.route",o),a.updateName(e))}else d.updateName(`${i} ${n}`)});c&&m?await w(m):(a=r.getActiveScopeSpan(),await r.withPropagatedContext(e.headers,()=>r.trace(l.BaseServerSpan.handleRequest,{spanName:`${i} ${n}`,kind:d.SpanKind.SERVER,attributes:{"http.method":i,"http.target":e.url}},w),void 0,!c))}catch(e){if(u.isDev)throw e;(0,a.sendError)(t,500,"Internal Server Error")}finally{null==i.waitUntil||i.waitUntil.call(i,Promise.resolve())}}e.s(["config",0,p,"default",0,g,"handler",0,c],91784)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0z6.au~._.js.map