module.exports=[44285,(T,E,t)=>{let{query:a}=T.r(35716),{DEFAULT_ORG_BIDANG:e,DEFAULT_ORG_MEMBERS:i,DEFAULT_ORG_PROGRAMS:s}=T.r(14534);function A(T){let E=String(T||"").trim();return!E||E.endsWith("/")?"":/^https?:\/\//i.test(E)||E.startsWith("/")?E:`/${E.replace(/^\.?\//,"")}`}async function r(){for(let T=0;T<e.length;T++){let E=e[T]||{};await a`
