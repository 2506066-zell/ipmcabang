...
</html>`)}}},35193,e=>{"use strict";var t=e.i(26747),a=e.i(90406),r=e.i(44898),i=e.i(62950),n=e.i(34777),o=e.i(7031),l=e.i(81927),s=e.i(46432);let p=(0,i.hoist)(n,"default"),c=(0,i.hoist)(n,"config"),m=new r.PagesAPIRouteModule({definition:{kind:a.RouteKind.PAGES_API,page:"/api/_article-share",pathname:"/api/_article-share",bundlePath:"",filename:""},userland:n,distDir:".next",relativeProjectDir:""});async function d(e,a,r){r.requestMeta&&(0,s.setRequestMeta)(e,r.requestMeta),m.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let i="/api/_article-share";i=i.replace(/\/index$/,"")||"/";let n=await m.prepare(e,a,{srcPage:i});if(!n){a.statusCode=400,a.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve());return}let{query:p,params:c,prerenderManifest:d,routerServerContext:g}=n;try{let t,r=e.method||"GET",n=(0,o.getTracer)(),s=n.getActiveScopeSpan(),u=!!(null==g?void 0:g.isWrappedByNextServer),h=m.instrumentationOnRequestError.bind(m),y=async o=>m.render(e,a,{query:{...p,...c},params:c,allowedRevalidateHeaderKeys:[],multiZoneDraftMode:!1,trustHostHeader:!1,previewProps:d.preview,propagateError:!1,dev:m.isDev,page:"/api/_article-share",internalRevalidate:null==g?void 0:g.revalidate,onError:(...t)=>h(e,...t)}).finally(()=>{if(!o)return;o.setAttributes({"http.status_code":a.statusCode,"next.rsc":!1});let e=n.getRootSpanAttributes();if(!e)return;if(e.get("next.span_type")!==l.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${e.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let s=e.get("next.route");if(s){let e=`${r} ${s}`;o.setAttributes({"next.route":s,"http.route":s,"next.span_name":e}),o.updateName(e),t&&t!==o&&(t.setAttribute("http.route",s),t.updateName(e))}else o.updateName(`${r} ${i}`)});u&&s?await y(s):(t=n.getActiveScopeSpan(),await n.withPropagatedContext(e.headers,()=>n.trace(l.BaseServerSpan.handleRequest,{spanName:`${r} ${i}`,kind:o.SpanKind.SERVER,attributes:{"http.method":r,"http.target":e.url}},y),void 0,!u))}catch(e){if(m.isDev)throw e;(0,t.sendError)(a,500,"Internal Server Error")}finally{null==r.waitUntil||r.waitUntil.call(r,Promise.resolve())}}e.s(["config",0,c,"default",0,p,"handler",0,d])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0s~yb0p._.js.map